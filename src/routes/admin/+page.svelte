...
<div class="container mx-auto px-6 py-8">
	...
	<div class="mt-6 flex flex-wrap gap-2">
		...
		<Button
			class="rounded border px-3 py-1 {currentSection === 'blogs'? 'bg-primary text-primary-foreground': ''}"
		...
		<Button
			class="rounded border px-3 py-1 {currentSection === 'donations'? 'bg-primary text-primary-foreground' : ''}" on:click={() => setSection("donation")}
		>
			Donations
		</Button>
		<Button
			class="rounded border px-3 py-1 {currentSection === 'messages'? 'bg-primary text-primary-foreground' : ''}"
			on:click={() => setSection("messages")}
		>
			Messages
		</Button>
			
		<Button class="rounded border px-3 py-1"type="destructive"
